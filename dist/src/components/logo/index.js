...
var _logo = _interopRequireDefault(require("./logo192.png"));
...
Logo.propTypes = {
  ...
  leftIndent: _propTypes.default.number
};
Logo.defaultProps = {
  image: _logo.default,
  width: 30,
...
function Logo(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_block.default, {
    style: {
      marginLeft: props.leftIndent + 'px',
    ...
    style: {
      ...
      fontWeight: 'bold',
      color: _constants.colors.bgColorTransparent2
    }
  }, props.label));
}
